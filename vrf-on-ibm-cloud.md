...
* VLAN spanning is a feature of the shared tenancy model and is not available, this will be disabled upon conversion to the multiple isolation model with a Customer VRF.
